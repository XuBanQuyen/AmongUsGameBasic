...
def make_impostors(number_of_impostors):
    ...
    new_imposter=create_impostors(colors_to_create)
    layout_impostors(new_imposter)
    animate_impostors(new_imposter)
    return new_imposter
...
def display_message(heading_text, sub_heading_text):
    screen.draw.text(heading_text,fonsize=60,center=CENTER,color=FONT_COLOR)
